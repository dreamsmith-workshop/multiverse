    ...
    namespace detail {
        class task_promise_base
        {
                ...
                struct final_awaitable
                {
                        ...
                        await_suspend(std::experimental::coroutine_handle<PROMISE> coroutine)
                        {
        ...
        class task_promise final : public task_promise_base
        {
            public:
                ...
                void
                return_value(VALUE&& value) noexcept(std::is_nothrow_constructible_v<T, VALUE&&>)
                {
...
#if CPPCORO_COMPILER_SUPPORTS_SYMMETRIC_TRANSFER
                    std::experimental::coroutine_handle<>
                    await_suspend(std::experimental::coroutine_handle<> awaitingCoroutine) noexcept
                    {
